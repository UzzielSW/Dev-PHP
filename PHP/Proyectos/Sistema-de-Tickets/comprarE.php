<!-- pagina de comprar estacionamientos -->
<!DOCTYPE html>
<html lang="es">
<head>
...
<div id="breadcrumb" class="section">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="breadcrumb-header">Comprar Estacionamientos</h3>
	...
	<div class="container">
			...
			<form class="form" action="pagar.php" method="post">
					...
					<div class="row">
						...
						<div class="col caja">
							<label>TIPO:</label>
							<select class="form-select tribuna" name="opcion" id="TIPO">
								<option value="1" selected>Estacionamientos</option>
							</select>
						</div>
						<!-- tribunas -->
						...
						<div class="col caja">
							...
							<select class="form-select opcnumeros" name="cantidad" id="CANT">
						...
						<div class="col-2">
							...
							<div>
								<h3 class="h3 precio" id="PRECIO">$3.00</h3>
							</div>
						</div>
						<!-- precio y cantidad -->
						...
						<div class="col-2 caja">
							<input type="submit" value="Comprar" name="comprarE">
						</div>
						<!-- submit -->
					</div>
					<!-- row -->
...
<script src="js/ajusteE.js"></script>
